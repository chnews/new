...
const Belowpostads = () => {
    ...
    const BelowpostadsApi = () => {
      const url = `${API}/below-post-ads`;
    ...
    <div className="form-group">
      ...
      <div className="dropzone-container mb-3">
          ...
          <div className="row">
            ...
            <button className="btn btn-primary" type='submit' onClick={BelowpostadsApi}>Save</button>
            </div>
        </div>
